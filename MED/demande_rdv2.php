...
$now = date("Y-m-d");
	...
	$queryHrCre = "SELECT heure_f_cre from creneau where id_rdv is null and date_cre = '$date_cre' and heure_d_cre='$heure_d_cre'";
	$resultHrDebCre = mysqli_query($conn, $queryHrCre);
	
	
	$yyy=0;
	if (isset($_REQUEST['cin_med'],$_REQUEST['date_cre'],$_REQUEST['heure_d_cre'],$_REQUEST['heure_f_cre']))
	{
		$yyy=1;
		...
		$query = "INSERT into `rendez_vous` (id_rdv, cin_pt, cin_med, date_rdv, heure_rdv, heure_f_rdv, confirme)
			VALUES (0, '$cin_pt', '$cin_med', '$date_cre', '$heure_d_cre', '$heure_f_cre', 'X')";
		...
		if($res)
		{
			...
			if($resultqueryNumDos )
			{
				...
				echo "<script type='text/javascript'>
						alert('La Demande a Bien été Effectuée!');
					</script>";
			}
		}
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
	...
	<select name="heure_f_cre" id="heure_f_cre" " class="form-control"  onchange="showDiv('submit', this)">
	...
	<div class="form-actions form-group"><input type="submit" id="submit" name="submit" class="btn btn-success btn-sm" value="Demander" style="display:none;"></div> 
