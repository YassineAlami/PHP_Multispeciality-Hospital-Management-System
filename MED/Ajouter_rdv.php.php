...
$queryDateRdv = "SELECT distinct date_cre, dayname(date_cre) as jour from creneau where cin_med='$cin_med'";
$resultDateRdv = mysqli_query($conn, $queryDateRdv);



if (isset($_REQUEST['date_cre']))
{
	...
	header("Location: Ajouter_rdv2.php");
															...
															<form action="" method="post">
																	...
																	<div class="form-group" id="divDateCre" onchange="showDiv('hidden_div3', this)">
                                                                        ...
                                                                        <select name="date_cre" id="date_cre" class="form-control">
                                                                            ...
                                                                            <?php while($row2 = mysqli_fetch_array($resultDateRdv)):;?>
																				<option value="<?php echo $row2[0];?>"><?php echo "$row2[0] ( $row2[1])"; ?></option>
																			<?php endwhile;?>
                                                                        </select>
                                                                    </div>
                                                                </div>
																...
																<div class="form-actions form-group"><input id="hidden_div3" type="submit" name="validerHeure" style="display:none;" class="btn btn-success btn-sm" value="Suivant"></div>
																
																<div class="row form-group" id="hidden_div2" name="hidden_div2" style="display:none;" onchange="showDiv('hidden_div4', this)">
                                                                    <div class="col col-md-3"></div>
                                                                    <div class="col-12 col-md-9">
                                                                        <select name="heure_f_cre" id="heure_f_cre" class="form-control">
                                                                            <option value="0">Heure Fin</option>
                                                                            <?php while($row2 = mysqli_fetch_array($resultHeureFinRdv)):;?>
																...
																<div class="row form-group" id="hidden_div4" style="display:none;"onchange="showDiv('hidden_div5', this)">
                                                                    <div class="col col-md-3"></div>
                                                                    <div class="col-12 col-md-9">
																...
																<div class="row form-group" id="hidden_div5" style="display:none;" onchange="showDiv('hidden_div6', this)">
                                                                    <div class="col col-md-3"></div>
                                                                    <div class="col-12 col-md-9">
