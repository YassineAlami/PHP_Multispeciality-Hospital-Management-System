...
if (isset($_REQUEST['cin_pt'], $_REQUEST['date_entree'], $_REQUEST['id_lit']))
{
	...
	$query = "INSERT into `hospitalisation` (num_dossier, id_lit, date_e_hosp)
		VALUES ('$num_dossier', '$id_lit', '$date_entree')";
	...
	if($res)
	{
		...
		if($resRempLit)
		{
			echo "<script type='text/javascript'>
				alert('L Hospitalisation a été Enregistré avec Succès!');
			</script>";
			/*
			echo "<div>
...
?>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="breadcrumbs" style="margin-bottom: 25px;">
		 ...
		 <div class="card">
                                                        <div class="card-header">Gestion des Hospitalisations</div>
															...
															<form action="" method="post">
																...
																<div class="form-group" id="divDateE">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="date" id="date_entree" name="date_entree" placeholder="La date d'entree (YYYY-MM-DD)" class="form-control">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col col-md-8"></div>
                                                                    <div class="col-12 col-md-12">
                                                                        <select name="etat_pt" id="etat_pt" class="form-control">
																			<option value="0">Etat du Patient</option>
																			<option value="Stable">Stable</option>
																			<option value="Médication">Critique</option>
																			<option value="Alimentation">Soin intensif</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-12 col-md-12">
                                                                        <select name="id_lit" id="Lit" class="form-control">
																			...
																			<?php while($row1 = mysqli_fetch_array($resultLits)):;?>
																			 <option value="<?php echo $row1[0];?>"><?php echo $row1[0]; echo " ("; echo "Chambre ".$row1[1]; echo ") ";?></option>
																			 <?php endwhile;?>
