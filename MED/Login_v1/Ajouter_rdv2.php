...
$queryHrCre = "SELECT heure_d_cre from creneau where id_rdv is null and date_cre = '$date_cre'";
$resultqueryHrCre = mysqli_query($conn, $queryHrCre);


if (isset($_REQUEST['date_cre'], $_REQUEST['heure_d_cre']) )
{
	...
	header("Location: Ajouter_rdv3.php");
}
		 ...
		 <div class="card">
                                                        ...
                                                        <div class="card-body card-block">
															...
															<form action="" method="post">
																...
																<div class="row form-group" id="div_hr_deb" onchange="showDiv('hidden_div3', this)">
                                                                    <div class="col col-md-3"></div>
                                                                    <div class="col-12 col-md-9">
                                                                        <select name="heure_d_cre" id="heure_d_cre" class="form-control">
                                                                            <option value="0">Heure Debut</option>
                                                                            <?php while($row2 = mysqli_fetch_array($resultqueryHrCre)):;?>
