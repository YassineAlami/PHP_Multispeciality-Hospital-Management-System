                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="card-header">
                                <strong class="card-title"> Créneaux Disponibles </strong>
                            </div>
                            <div class="card-body">
							...
							<?php 
							$queryMedServ = "SELECT date_cre, heure_d_cre, heure_f_cre from creneau where id_rdv is null";
							...
							if($resultN = mysqli_query($conn, $queryMedServ))
							{
								if(mysqli_num_rows($resultN) > 0)
								{
									...
									{
										echo "<tr>";
											echo "<td>" . $row['date_cre'] . "</td>";
											echo "<td>" . $row['heure_d_cre'] . "</td>";
											echo "<td>" . $row['heure_f_cre'] . "</td>";
											$_SESSION["date_cre$i"] = $row['date_cre'];
											$i=$i+1;
											$_SESSION ['heure_d_cre$j'] = $row ['heure_d_cre'];
											$j=$j+1;
											echo "<td><a href='Ajouter_rdv.php.php'> Utiliser</a></td>";
										echo "</tr>";
									}
								}
							}
