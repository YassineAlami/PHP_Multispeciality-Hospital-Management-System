...
session_start();
	...
	$queryRdv = "SELECT nom_pt, pnom_pt, year(date_rdv)as an_rdv,month(date_rdv)as mo_rdv, day(date_rdv) as j_rdv, HOUR(heure_rdv) as hr_d, minute(heure_rdv) as min_d_rdv, HOUR(heure_f_rdv) as hr_f, minute(heure_f_rdv) as min_f_rdv, lbl_type_trai from rendez_vous INNER JOIN patient on rendez_vous.cin_pt=patient.cin_pt WHERE cin_med='$cin_med' and confirme= 'Y' ";
