...
$queryHrFin = "SELECT heure_f_cre from creneau where id_rdv is null and date_cre = '$date_cre' and heure_d_cre = '$heure_d_cre'";
		 ...
		 <div class="card">
                                                        ...
                                                        <div class="card-body card-block">
															...
															<form action="" method="post">
																...
																<div class="row form-group" id="divDateCre">
																...
																<div class="row form-group" id="div_hr_deb" >
                                                                    <div class="col col-md-3"></div>
                                                                    <div class="col-12 col-md-9">
																...
																<div class="row form-group" id="div_hr_fin" onchange="showDiv('hidden_div3', this)">
                                                                    <div class="col col-md-3"></div>
                                                                    <div class="col-12 col-md-9">
																...
																<div class="row form-group" style="display:none;" id="hidden_div3" onchange="showDiv('hidden_div4', this)">
                                                                    <div class="col col-md-3"></div>
                                                                    <div class="col-12 col-md-9">
																...
																<div class="row form-group" style="display:none;" id="hidden_div4" onchange="showDiv('hidden_divxxx', this)">
                                                                    <div class="col col-md-3"></div>
                                                                    <div class="col-12 col-md-9">
																...
																<div class="form-actions form-group"><input id="hidden_divxxx" type="submit" name="hidden_div3" style="display:none;" class="btn btn-success btn-sm" value="Valider"></div>
