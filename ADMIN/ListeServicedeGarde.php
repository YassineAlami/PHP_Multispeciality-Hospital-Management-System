    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="card-header">
                                <strong class="card-title">Service de garde</strong>
                            </div>
                            <div class="card-body">
                            <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <label>
                                    <input type="text" class="form-control form-control-sm" placeholder="Recherche par date"
            ...
            <?php
                    ...
                    $sql = "SELECT * FROM medecin_service order by date_serv desc";
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            echo '<table class="table table-bordered table-striped" id="tableau">';
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th>CIN Médecin </th>";
                                        echo "<th>Date de service</th>";
                                        echo "<th> Action</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>" . $row['date_serv'] . "</td>";
                                        
                                        echo "<td>";
                                            echo '<a href="CrudServiceGarde/read.php?cin_med='. $row['cin_med'] .'" class="me-3" ><span style="color:blue" class="bi bi-eye"></span></a>';
