...
if (isset($_REQUEST['type_ch'], $_REQUEST['prix_ch'], $_REQUEST['si_pris']))
{	
	
	// récupérer le nom d'utilisateur et supprimer les antislashes ajoutés par le formulaire
	$type_ch = stripslashes($_REQUEST['type_ch']);
	$type_ch = mysqli_real_escape_string($conn, $type_ch);
	// récupérer l'email et supprimer les antislashes ajoutés par le formulaire
	$prix_ch = stripslashes($_REQUEST['prix_ch']);
	$prix_ch = mysqli_real_escape_string($conn, $prix_ch);
	// récupérer le mot de passe et supprimer les antislashes ajoutés par le formulaire
	
	$si_pris = stripslashes($_REQUEST['si_pris']);
	$si_pris = mysqli_real_escape_string($conn, $si_pris);
	


	$query = "INSERT into `chambre` (type_ch, prix_ch,si_pris)
		VALUES ('$type_ch', '$prix_ch', '$si_pris')";
                                                 ...
                                                 <form action="" method="post">
                                                              ...
                                                              <div class="form-group">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" id="type_ch" name="type_ch" placeholder="Type de chambre" class="form-control">
                                                                    </div>
                                                               </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" id="prix_ch" name="prix_ch" placeholder="Prix de la chambre" class="form-control">
                                                                    </div>
                                                               </div>
															   ...
															   <div class="row form-group">
                                                                    ...
                                                                    <div class="col-12 col-md-9">
                                                                        <select name="si_pris" id="si_pris" class="form-control">
