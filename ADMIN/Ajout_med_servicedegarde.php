...
$querySpe = "SELECT cin_med, nom_med FROM `medecin`";
$resultSpe = mysqli_query($conn, $querySpe);


if (isset($_REQUEST['cin_med'], $_REQUEST['date_serv']))
{	
	...
	$date_serv= stripslashes($_REQUEST['date_serv']);
	$date_serv = mysqli_real_escape_string($conn, $date_serv);
	


	$query = "INSERT into `medecin_service` (cin_med,date_serv)
		VALUES ('$cin_med', '$date_serv')";
	...
	{			
		echo '
            <script type="text/javascript">
                alert("affecter avec succès"); 
                window.location.href = "ListeServicedeGarde.php";</script>'; 
...
/.menu-title -->
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="breadcrumbs">
		 ...
		 <div class="card">
                                                        <div class="card-header">Affectation au service de garde</div>
                                                 ...
                                                 <div class="row form-group">
                                                                    ...
                                                                    <div class="col-12 col-md-9">
                                                                        <select name="cin_med" id="cin_med" class="form-control">
                                                                            <option value="0">Liste Medecins</option>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group">
																		...
																		<input type="date" id="date_serv" name="date_serv" placeholder="La date de Naissance (YYYY-MM-DD)" class="form-control" 
