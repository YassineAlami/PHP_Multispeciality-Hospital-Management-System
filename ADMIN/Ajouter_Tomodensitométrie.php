...
if (isset($_REQUEST['id_tomo'],$_REQUEST['tomo']))
{	
	...
	$tomo = stripslashes($_REQUEST['tomo']);
	$tomo= mysqli_real_escape_string($conn, $tomo);
	


	$query = "INSERT into `tomodensitometrie` (id_tomo,lbl_tomo)
		VALUES ('$id_tomo','$tomo')";
		 ...
		 <div class="card">
              ...
              <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" id="id_tomo" name="id_tomo" placeholder="Entrer id_tomo " class="form-control">
                        </div>
                    </div>

                    <div class="input-group">
                    <div class="input-group-addon"><i class="fa fa-user"></i></div>
                    <input type="text" id="tomo" name="tomo" placeholder="Entrer la Tomodensitométrie " class="form-control">
                        </div>
                    </div>   
