    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="card-header">
                                <strong class="card-title">Hospitalisation</strong>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <label>
                                    <input type="text" class="form-control form-control-sm" placeholder="Recherche par noms" 
            ...
            <?php
                    ...
                    $sql = "SELECT * FROM hospitalisation hosp join dossier_medical dmed on hosp.num_dossier=dmed.num_dossier
                     join patient p on dmed.cin_pt=p.cin_pt;" ;
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            echo '<table class="table table-bordered table-striped" id="tableau">';
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th>Id Hospitalisation </th>";
                                       
                                        echo "<th>Id Lit </th>";
                                        echo "<th>Numéro dossier</th>";
                                        echo "<th>CIN Patient </th>";
