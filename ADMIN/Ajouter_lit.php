...
if (isset($_REQUEST['num_ch']))
{	
	
	// récupérer le nom d'utilisateur et supprimer les antislashes ajoutés par le formulaire
	$num_ch = stripslashes($_REQUEST['num_ch']);
	$num_ch = mysqli_real_escape_string($conn, $num_ch);
	
	
	


	$query = "INSERT into `lit` (num_ch,si_pris)
		VALUES ('$num_ch', 'N')";
...
/.menu-title -->
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="breadcrumbs">
		 ...
		 <div class="card">
                                                        <div class="card-header">Ajouter un lit</div>
