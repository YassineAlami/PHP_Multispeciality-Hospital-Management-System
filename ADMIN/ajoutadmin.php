...
if (isset($_REQUEST['cin_admin'], $_REQUEST['nom_admin'], $_REQUEST['pnom_admin'], $_REQUEST['genre_admin'], $_REQUEST['email_admin'],$_FILES['admin_image']))
{	
	
	// récupérer le nom d'utilisateur et supprimer les antislashes ajoutés par le formulaire
	$cin_admin = stripslashes($_REQUEST['cin_admin']);
	$cin_admin = mysqli_real_escape_string($conn, $cin_admin);
	// récupérer l'email et supprimer les antislashes ajoutés par le formulaire
	$nom_admin = stripslashes($_REQUEST['nom_admin']);
	$nom_admin = mysqli_real_escape_string($conn, $nom_admin);
	// récupérer le mot de passe et supprimer les antislashes ajoutés par le formulaire
	$pnom_admin = stripslashes($_REQUEST['pnom_admin']);
	$pnom_admin = mysqli_real_escape_string($conn, $pnom_admin);
	
	$genre_admin = stripslashes($_REQUEST['genre_admin']);
	$genre_admin = mysqli_real_escape_string($conn, $genre_admin);
	
	$email_admin = stripslashes($_REQUEST['email_admin']);
	$email_admin = mysqli_real_escape_string($conn, $email_admin);
	
    $admin_image = $_FILES['admin_image']['name'];
    $med_image_tmp_name = $_FILES['admin_image']['tmp_name'];
    $profile_image_folder = 'profile_admin_image/'.$admin_image;
 
    

	$query = "INSERT into `admin_app` (cin_admin, nom_admin, pnom_admin, genre_admin,email_admin,image)
		VALUES ('$cin_admin', '$nom_admin', '$pnom_admin', '$genre_admin',  '$email_admin','$admin_image')";
	...
	{		
		...
		$queryUseradmin2 = "INSERT into `user_app` (email_user, psw_user,type_user)
		VALUES ('$email_admin','123','Admin')";
		// Exécute la requête sur la base de données
		$resUseradmin2 = mysqli_query($conn, $queryUseradmin2);
		if($resUseradmin2)
		{
            echo '
...
/.menu-title -->
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="breadcrumbs">
		 ...
		 <div class="card">
                                                        <div class="card-header">Ajouter un Admin</div>
                                                 ...
                                                 <form action="" method="post" enctype="multipart/form-data">
                                                              ...
                                                              <div class="form-group">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" id="cin_admin" name="cin_admin" placeholder="CIN" class="form-control">
                                                                    </div>
                                                               </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                                                        <input type="text" id="nom" name="nom_admin" placeholder="Nom" class="form-control">
                                                                    </div>
                                                               </div>
                                                               <div class="form-group">
                                                                    <div class="input-group">
                                                                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                                                                        <input type="text" id="prenom" name="pnom_admin" placeholder=" Prenom" class="form-control">
                                                                    </div>
                                                               </div>
															   ...
															   <div class="row form-group">
                                                                    ...
                                                                    <div class="col-12 col-md-9">
                                                                        <select name="genre_admin" id="sexe" class="form-control">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="file" class="form-control" name="admin_image"  accept="image/png, image/jpeg, image/jpg">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" id="email" name="email_admin" placeholder="Email" class="form-control">
                                                                    </div>
                                                                </div>
