...
if (isset($_REQUEST['id_op'],$_REQUEST['lbl_op']))
{	
	...
	$lbl_op = stripslashes($_REQUEST['lbl_op']);
	$lbl_op= mysqli_real_escape_string($conn, $lbl_op);
	


	$query = "INSERT into `operation` (id_op,lbl_op)
		VALUES ('$id_op','$lbl_op')";
...
/.menu-title -->
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="breadcrumbs">
		 ...
		 <div class="card">
                      <div class="card-header">Ajouter une Tomodensitométrie</div>
              ...
              <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" id="id_op" name="id_op" placeholder="Entrer id operation " class="form-control">
                        </div>
                    </div>

                    <div class="input-group">
                    <div class="input-group-addon"><i class="fa fa-user"></i></div>
                    <input type="text" id="lbl_op" name="lbl_op" placeholder="Entrer un type d'opération " class="form-control">
                        </div>
                    </div>   
