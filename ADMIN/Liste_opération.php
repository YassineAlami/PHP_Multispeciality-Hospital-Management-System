                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="card-header">
                                <strong class="card-title">Listes des Opérations</strong>
                            </div>
                            <div class="card-body">
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo '<a href="Crudoperation/update.php?id_op='. $row['id_op'] .'" class="me-3" ><span style="color:black" class="bi bi-pencil"></span></a>';
