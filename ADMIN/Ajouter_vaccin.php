...
$querySpe = "SELECT id_type_vcc, lbl_type_vcc FROM `type_vaccin`";
$resultSpe = mysqli_query($conn, $querySpe);


if (isset($_REQUEST['id_type_vcc'], $_REQUEST['lbl_vcc']))
{	
	
	// récupérer le nom d'utilisateur et supprimer les antislashes ajoutés par le formulaire
	$id_type_vcc = stripslashes($_REQUEST['id_type_vcc']);
	$id_type_vcc = mysqli_real_escape_string($conn, $id_type_vcc);
	
	// récupérer le mot de passe et supprimer les antislashes ajoutés par le formulaire
	
	$lbl_vcc= stripslashes($_REQUEST['lbl_vcc']);
	$lbl_vcc = mysqli_real_escape_string($conn, $lbl_vcc);
	


	$query = "INSERT into `vaccin` (id_type_vcc,lbl_vcc)
		VALUES ('$id_type_vcc', '$lbl_vcc')";
...
/.menu-title -->
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="breadcrumbs">
		 ...
		 <div class="card">
                                                        <div class="card-header">Ajouter un Vaccin</div>
                                                 ...
                                                 <div class="row form-group">
                                                                    ...
                                                                    <div class="col-12 col-md-9">
                                                                        <select name="id_type_vcc" id="id_type_vcc" class="form-control">
                                                                            <option value="0">Type vaccin</option>
                    ...
                    <input type="text" id="lbl_vcc" name="lbl_vcc" placeholder="Entrer le vaccin " class="form-control">
                        </div>
                    </div>   
