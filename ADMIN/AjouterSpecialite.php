...
if (isset($_REQUEST['spe']))
{	
	
	// récupérer de la spécialité et supprimer les antislashes ajoutés par le formulaire
	$spe = stripslashes($_REQUEST['spe']);
	$spe = mysqli_real_escape_string($conn, $spe);
	


	$query = "INSERT into `specialite` (lib_spe)
		VALUES ('$spe')";
...
/.menu-title -->
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="breadcrumbs">
		 ...
		 <div class="card">
                      <div class="card-header">Ajouter une Specialité</div>
              ...
              <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" id="spe" name="spe" placeholder="Entrer la specialité" class="form-control">
                        </div>
                    </div>
