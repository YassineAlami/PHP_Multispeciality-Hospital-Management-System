    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="card-header">
                                <strong class="card-title">Médecins</strong>
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <label>
                                    <input type="text" class="form-control form-control-sm" placeholder="Recherche par nom" 
            ...
            <?php
                    ...
                    $sql = "SELECT * FROM medecin ORDER BY nom_med";
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<th> Action</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        echo "<td>" . $row['cin_med'] . "</td>";
                                       
                                        echo "<td>" . $row['id_spe'] . "</td>";
                                        echo "<td>" . $row['nom_med'] . "</td>";
                                        echo "<td>" . $row['pnom_med'] . "</td>";
                                        echo "<td>" . $row['genre_med'] . "</td>";
                                        echo "<td>" . $row['date_n_med'] . "</td>";
                                      
                                     echo "<td>" . $row['tel_med'] . "</td>";
                                     echo "<td>" . $row['email_med'] . "</td>";
                                        echo "<td>";
                                            echo '<a href="CrudMedecin/read.php?cin_med='. $row['cin_med'] .'" class="me-3" ><span style="color:blue" class="bi bi-eye"></span></a>';
                                            echo '<a href="CrudMedecin/update.php?cin_med='. $row['cin_med'] .'" class="me-3" ><span style="color:black" class="bi bi-pencil"></span></a>';
                                            echo '<a href="CrudMedecin/delete.php?cin_med='. $row['cin_med'] .'" ><span style="color:red"class="bi bi-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
