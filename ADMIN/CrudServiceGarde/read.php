                ...
                <div class ="jumbotron">
                  <div class="row">
                      <div style="margin-top:105px" class="col-md-4 col-xs-12 col-sm-6 col-lg-4">
                          <img src="../profile_image/<?php echo $image; ?>" alt="stack photo" class="rounded-circle"  width="230px">
                      ...
                      <div class="col-md-8 col-xs-12 col-sm-6 col-lg-8">
                          ...
                          <li><p><span class="glyphicon glyphicon-hand-right" style="width:50px;"></span>Sexe : <?php echo $row["genre_med"]; ?></p></li>
                            ...
                            <li><p><span class="glyphicon glyphicon-new-window one" style="width:50px;"></span><a href="../ListeServicedeGarde.php" class="btn btn-primary">Retour</p></a>
                          </ul>
                      </div>
                  </div>
                </div>