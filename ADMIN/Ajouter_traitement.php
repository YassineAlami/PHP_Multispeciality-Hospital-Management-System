...
if (isset($_REQUEST['lbl_type_trai'], $_REQUEST['frai_trai']))
{	
	...
	$frai_trai= stripslashes($_REQUEST['frai_trai']);
	$frai_trai = mysqli_real_escape_string($conn, $frai_trai);
	

	$query = "INSERT into `type_traitement` (lbl_type_trai,frai_trai)
		VALUES ('$lbl_type_trai', '$frai_trai')";
	...
	{			
		echo '
            <script type="text/javascript">
                ...
                window.location.href = "Ajout_traitement.php";</script>'; 
...
/.menu-title -->
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="breadcrumbs">
		 ...
		 <div class="card">
                                                        <div class="card-header">Ajouter un Type de traitement</div>
                                                 ...
                                                 <form action="" method="post">
                                                              ...
                                                              <div class="form-group">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" id="lbl_type_trai" name="lbl_type_trai" placeholder="Entrer le type " class="form-control">
                                                                    </div>
                                                               </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" id="frai_trai" name="frai_trai" placeholder="Prix" class="form-control">
                                                                    </div>
                                                               </div>
