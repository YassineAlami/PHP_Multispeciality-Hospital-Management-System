                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="card-header">
                                <strong class="card-title">Listes des Lits</strong>
                            </div>
                            <div class="card-body">
                            <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <label>
                                    <input type="text" class="form-control form-control-sm" placeholder="Recherche" 
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo '<a href="CrudLits/update.php?id_lit='. $row['id_lit'] .'" class="me-3" ><span style="color:black" class="bi bi-pencil"></span></a>';
                                            echo '<a href="CrudLits/delete.php?id_lit='. $row['id_lit'] .'" ><span style="color:red"class="bi bi-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
