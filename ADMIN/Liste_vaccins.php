                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="card-header">
                                <strong class="card-title">Listes des Vaccins</strong>
                            </div>
                            <div class="card-body">
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            echo '<table class="table table-bordered table-striped">';
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th>id_vaccin</th>";
                                        echo "<th>id_type du vaccin</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        echo "<td>" . $row['id_vcc'] . "</td>";
                                        echo "<td>" . $row['id_type_vcc'] . "</td>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo '<a href="CrudVaccin/update.php?id_vcc='. $row['id_vcc'] .'" class="me-3" ><span style="color:black" class="bi bi-pencil"></span></a>';
                                            echo '<a href="CrudVaccin/delete.php?id_vcc='. $row['id_vcc'] .'" ><span style="color:red"class="bi bi-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
