                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="card-header">
                                <strong class="card-title">Specialités</strong>
                            </div>
                            <div class="card-body">
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo '<a href="CrudSpecialite/update.php?id_spe='. $row['id_spe'] .'" class="me-3" ><span style="color:black" class="bi bi-pencil"></span></a>';
