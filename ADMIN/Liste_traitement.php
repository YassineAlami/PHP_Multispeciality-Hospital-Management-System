                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="card-header">
                                <strong class="card-title">Listes des Traitements</strong>
                            </div>
                            <div class="card-body">
                        ...
                        if(mysqli_num_rows($result) > 0){
                            echo '<table class="table table-bordered table-striped">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        echo "<td>" . $row['lbl_type_trai'] . "</td>";
                                        echo "<td>" . $row['frai_trai'] . "</td>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo '<a href="Crudtraitement/update.php?lbl_type_trai='. $row['lbl_type_trai'] .'" class="me-3" ><span style="color:black" class="bi bi-pencil"></span></a>';
