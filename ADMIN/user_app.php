                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="card-header">
                                <strong class="card-title">Liste d'Utilisateurs</strong>
                            </div>
                            <div class="card-body">
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            echo '<table class="table table-bordered table-striped" id="tableau">';
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th>Email d'utilisateurs </th>";
                                        echo "<th>Type d'Utilisateurs</th>";
                                        echo "<th> Action</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo '<a href="CrudUser/delete.php?email_user='. $row['email_user'] .'" ><span style="color:red"class="bi bi-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
