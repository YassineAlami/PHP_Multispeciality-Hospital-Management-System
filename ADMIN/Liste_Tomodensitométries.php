    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="card-header">
                                <strong class="card-title">Tomodensitometrie</strong>
                            </div>
                            <div class="card-body">
            ...
            <?php
                    ...
                    $sql = "SELECT * FROM tomodensitometrie";
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            echo '<table class="table table-bordered table-striped">';
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th>id_tomodensitometrie </th>";
                                        echo "<th>tomo</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo '<a href="Crudtomo/update.php?id_tomo='. $row['id_tomo'] .'" class="me-3" ><span style="color:black" class="bi bi-pencil"></span></a>';
