    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                             <div class="card-header">
                                <strong class="card-title">Assistants de Médecins</strong>
                            </div>
                            <div class="card-body">
            ...
            <?php
                    ...
                    $sql = "SELECT * FROM infirmiere ORDER BY nom_inf";
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<th> Action</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        echo "<td>" . $row['cin_inf'] . "</td>";
                                       
                                        echo "<td>" . $row['nom_inf']." ".$row['pnom_inf'] . "</td>";
                                        echo "<td>" . $row['genre_inf'] . "</td>";
                                        echo "<td>" . $row['tel_inf'] . "</td>";
                                      
                                     echo "<td>" . $row['email_inf'] . "</td>";
                                        echo "<td>";
                                            
                                            echo '<a href="CrudAssistants/update.php?cin_inf='. $row['cin_inf'] .'" class="me-3" ><span style="color:black" class="bi bi-pencil"></span></a>';
                                            echo '<a href="CrudAssistants/delete.php?cin_inf='. $row['cin_inf'] .'" ><span style="color:red"class="bi bi-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
